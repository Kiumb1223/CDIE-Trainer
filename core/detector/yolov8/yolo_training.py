...
from .utils_bbox import dist2bbox, make_anchors
...
class V8Loss:
    ...
    def __init__(
            ...
            stride,
            reg_max = 16,
            **kwargs, # filter out the irrelavent params
        ):
        """
            rewrite __init__ func 
            in order to decouple the initialization of model and loss 
        """
        ...
        self.assigner = TaskAlignedAssigner(topk=10,
                                            ...
                                            beta=6.0,
                                            roll_out_thr=roll_out_thr)
        self.bbox_loss  = BboxLoss(reg_max - 1, use_dfl=self.use_dfl)
